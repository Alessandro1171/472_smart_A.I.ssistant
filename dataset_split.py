...
def split_dataset(base_paths, train_ratio=0.7, val_ratio=0.15, test_ratio=0.15):
    """
    splits data from dataset into training, validation, and test set base on their rations
    :param base_paths class int
    :param train_ratio class int
    :param val_ratio class int
    :param test_ratio class int
    :return class string
    """
